...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-JDMM5F1\\MSSQLSERVER01; Initial Catalog = nopCommerce; Integrated Security = SSPI; TrustServerCertificate = True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<InvoiceSell>(entity =>
        {
            ...
            entity.Property(e => e.BillTypeSubNo).HasColumnName("billTypeSubNo");
            entity.Property(e => e.BlueWeightNo).HasColumnName("blueWeightNo");
            entity.Property(e => e.BuyPriceCostPriceTotal)
                .HasColumnType("decimal(18, 6)")
                .HasColumnName("buyPrice_costPriceTotal");
            entity.Property(e => e.CalculatedCreditAmount)
                .HasColumnType("decimal(18, 6)")
                .HasColumnName("calculatedCreditAmount");
            entity.Property(e => e.CalculatedDebitAmount)
                .HasColumnType("decimal(18, 6)")
                .HasColumnName("calculatedDebitAmount");
            entity.Property(e => e.CalculatedPayed)
                .HasColumnType("decimal(18, 6)")
                .HasColumnName("calculatedPayed");
            ...
            entity.Property(e => e.DeviceMakeYear).HasColumnName("device_makeYear");
            entity.Property(e => e.DeviceMakerNo).HasColumnName("device_makerNo");
            entity.Property(e => e.DeviceMileage)
                .HasColumnType("decimal(13, 6)")
                .HasColumnName("device_mileage");
            entity.Property(e => e.DeviceModel)
                .HasMaxLength(150)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("device_model");
            entity.Property(e => e.DeviceNextMileage)
                .HasColumnType("decimal(13, 6)")
                .HasColumnName("device_next_mileage");
            entity.Property(e => e.DeviceNextServiceDate)
                .HasColumnType("date")
                .HasColumnName("device_next_serviceDate");
            entity.Property(e => e.DeviceNextServiceDateH)
                .HasMaxLength(20)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("device_next_serviceDateH");
            entity.Property(e => e.DevicePlate)
                .HasMaxLength(27)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("device_plate");
            entity.Property(e => e.DeviceSerial1)
                .HasMaxLength(27)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("device_serial_1");
            entity.Property(e => e.DeviceSerial2)
                .HasMaxLength(27)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("device_serial_2");
            ...
            entity.Property(e => e.GaztInvoiceHash)
                .HasMaxLength(100)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("gaztInvoiceHash");
            entity.Property(e => e.GaztInvoiceNumber)
                .HasMaxLength(20)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("gaztInvoiceNumber");
            entity.Property(e => e.GaztInvoiceTypeCode).HasColumnName("gaztInvoiceTypeCode");
            entity.Property(e => e.GaztInvoiceTypeCodeSubType).HasColumnName("gaztInvoiceTypeCode_SubType");
            entity.Property(e => e.GaztLatestDeliveryDate)
                .HasColumnType("date")
                .HasColumnName("gaztLatestDeliveryDate");
            entity.Property(e => e.GaztPreviousInvoiceHash)
                .HasMaxLength(100)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("gaztPreviousInvoiceHash");
            entity.Property(e => e.GaztUniqueInvoiceIdentifier)
                .HasMaxLength(40)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("gaztUniqueInvoiceIdentifier");
            entity.Property(e => e.Idcard)
                .HasMaxLength(27)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("IDCard");
            entity.Property(e => e.InvBillTypeNo).HasColumnName("Inv_billTypeNo");
            entity.Property(e => e.InvBuildingNo)
                .HasColumnType("decimal(28, 0)")
                .HasColumnName("Inv_buildingNo");
            entity.Property(e => e.InvInvoiceNo).HasColumnName("Inv_invoiceNo");
            entity.Property(e => e.InvUserNumber)
                .HasMaxLength(20)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("Inv_userNumber");
            ...
            entity.Property(e => e.IsCreateGlass).HasColumnName("isCreateGlass");
            ...
            entity.Property(e => e.IsFastCleaning).HasColumnName("isFastCleaning");
            entity.Property(e => e.IsFastInvoice).HasColumnName("isFastInvoice");
            entity.Property(e => e.IsGlposted).HasColumnName("isGLPosted");
            entity.Property(e => e.IsHangerOrFold).HasColumnName("isHangerOrFold");
            ...
            entity.Property(e => e.IsPaperInvoiceReturned).HasColumnName("isPaperInvoiceReturned");
            ...
            entity.Property(e => e.IsSpot).HasColumnName("isSpot");
            ...
            entity.Property(e => e.RentQuantity)
                .HasColumnType("decimal(18, 6)")
                .HasColumnName("rentQuantity");
            entity.Property(e => e.RentReturnDate)
                .HasColumnType("date")
                .HasColumnName("rentReturnDate");
            ...
            entity.Property(e => e.SpoilTypeNo).HasColumnName("spoilTypeNo");
            ...
            entity.Property(e => e.StarchNo).HasColumnName("starchNo");
            ...
            entity.Property(e => e.TrainingHourseLeft)
                .HasColumnType("decimal(14, 6)")
                .HasColumnName("trainingHourseLeft");
            entity.Property(e => e.TrainingHourseToBeGiven)
                .HasColumnType("decimal(14, 6)")
                .HasColumnName("trainingHourseToBeGiven");
        ...
        modelBuilder.Entity<InvoiceSellUnit>(entity =>
        {
            ...
            entity.Property(e => e.DateDifferenceInDays)
                .HasColumnType("decimal(13, 6)")
                .HasColumnName("dateDifferenceInDays");
            entity.Property(e => e.DeliveryDate)
                .HasColumnType("date")
                .HasColumnName("deliveryDate");
            entity.Property(e => e.DeliveryDateH)
            ...
            entity.Property(e => e.MerzamTypeNo).HasColumnName("merzamTypeNo");
            entity.Property(e => e.Note)
                .HasMaxLength(150)
                .UseCollation("Arabic_CI_AS")
                .HasColumnName("note");
